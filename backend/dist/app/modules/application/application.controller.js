...
const applyJob = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, application_service_1.applyJobService)(req.body);
...
const getApplicationsByJob = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, application_service_1.getApplicationsByJobService)(req.params.jobId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
